	...
	<div class="" id="login-modal">
    	  <div class="modal-dialog">
				<div class="loginmodal-container">
					...
					<li class="dropdown"><a style="color: black;" class="dropdown-toggle" data-toggle="dropdown" href="#">Login As Student <span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="../html/company-login.html">Login As Company</a></li>
					<li><a href="../html/staff-login.html">Login As Staff</a></li>
				</ul>
			</li></ul>
				  <form action="backend/backend_student_login.php" method="post">
					<input type="text"  placeholder="Adm No." name="admin_no"/>
					<input type="password" placeholder="Password" name="sPassword" />
					<button style="margin-left: 10px;" type="submit" class="btn btn-danger buttonpopup pull-right">Login</button>
